...
!function($){
  ...
  Typeahead.prototype = {
    ...
    select: function () {
      ...
      // SSMITH - Added this to include an ID.
      var valID = this.$menu.find('.active').attr('data-id');

      console.log('Selected Value', val, valID);
    ...
    render: function (items) {
      ...
      items = $(items).map(function (i, item) {
        ...
        i = $(that.options.item).attr('data-value', itemValue).attr('data-id', itemID);
        i.find('a').html(that.highlighter(itemValue))
